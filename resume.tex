...
\cvtag{MongoDB}
\cvtag{NLP}
\cvtag{Knowledge Graph}
\cvtag{API}

\cvtag{Graph Neural Network}
...
% \item Collaborated with data engineer, domain expert and solution architect along with leading 6 team members to design federated ML architecture to deploy ML solution across 5000+ sites to limit the response time in seconds
